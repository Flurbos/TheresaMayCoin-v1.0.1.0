...
unsigned int nTargetSpacing = 1 * 300; // TheresaMay - 5 minute blocks
...
unsigned int nModifierInterval = 10 * 60; // TheresaMay - time to elapse before new modifier is computed
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 1)
	    ...
	    else if(pindexBest->nHeight < 30201)
    	{
            nSubsidy = 0 * COIN;
    	}
	    else if(pindexBest->nHeight < 42001)
    	{
            nSubsidy = 10 * COIN; //100000
    	}
	    else if(pindexBest->nHeight < 62001)
    	{
            nSubsidy = 50 * COIN; //1000000
    	}
	    else if(pindexBest->nHeight < 82001)
    	{
            nSubsidy = 100 * COIN; //3000000
    	}
	    else if(pindexBest->nHeight < 112001)
    	{
            nSubsidy = 200 * COIN; //8000000
    	}
	    else if(pindexBest->nHeight < 162001)
    	{
            nSubsidy = 400 * COIN; //20000000
    	}
	    else if(pindexBest->nHeight < 222001)
    	{
            nSubsidy = 800 * COIN; //48000000
    	}
	    else if(pindexBest->nHeight < 223901)
    	{
            nSubsidy = 1000 * COIN; //4900000
    	}
...
int64_t GetProofOfStakeReward(int64_t nCoinAge, int64_t nFees)
{
    ...
    if(pindexBest->nHeight < 201)
	    ...
	    else if(pindexBest->nHeight < 12001)
    	{
            nSubsidy = 10 * COIN; //100000
    	}
	    else if(pindexBest->nHeight < 32001)
    	{
            nSubsidy = 50 * COIN; //1000000
    	}
	    else if(pindexBest->nHeight < 62001)
	    ...
	    else if(pindexBest->nHeight < 102001)
    	{
            nSubsidy = 200 * COIN; //8000000
    	}
	    ...
	    else if(pindexBest->nHeight < 212001)
    	{
            nSubsidy = 800 * COIN; //48000000
    	}
	    else if(pindexBest->nHeight < 216901)
    	{
            nSubsidy = 1000 * COIN; //4900000
    	}
	    else if(pindexBest->nHeight > 216900)
        {
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TheresaMay", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        assert(block.hashMerkleRoot == uint256("0xab389382081431342fdd6a946fa28faf6e1846f8cfc92fbff3d3c1df11d46874"));
    ...
    string strPubKey = "04fc9702847840aaf195de8442ebecedf5b095cdbb9bc716bda9110971b28a49e0ead8564ff0db22209e0374782c093bb899692d524e9d6a6956e7c5ecbcd68284";
